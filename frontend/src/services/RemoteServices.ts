...
export default class RemoteServices {
  ...
  static async createAssessment(userId: number, institutionId: number, assessment: Assessment) {
    return httpClient
  ...
  static async getVolunteerParticipations(userId: number) {
    return httpClient
  ...
  static async getVolunteerAssessments(userId: number) {
    return httpClient
